...
import { handler as auth } from '../lib/api-handlers/_auth'
import { handler as authLogout } from '../lib/api-handlers/_auth-logout'
import { handler as authMe } from '../lib/api-handlers/_auth-me'
import { handler as portfolio } from '../lib/api-handlers/_portfolio'
import { handler as portfolioId } from '../lib/api-handlers/_portfolio-id'
import { handler as portfolioTaxLoss } from '../lib/api-handlers/_portfolio-tax-loss'
import { handler as watchlist } from '../lib/api-handlers/_watchlist'
import { handler as watchlistId } from '../lib/api-handlers/_watchlist-id'
import { handler as alerts } from '../lib/api-handlers/_alerts'
import { handler as alertsId } from '../lib/api-handlers/_alerts-id'
import { handler as scores } from '../lib/api-handlers/_scores'
import { handler as news } from '../lib/api-handlers/_news'
import { handler as chat } from '../lib/api-handlers/_chat'
import { handler as screener } from '../lib/api-handlers/_screener'
import { handler as screenerRank } from '../lib/api-handlers/_screener-rank'
import { handler as reportsIndex } from '../lib/api-handlers/_reports-index'
import { handler as reportsGenerate } from '../lib/api-handlers/_reports-generate'
import { handler as discoveryIndex } from '../lib/api-handlers/_discovery-index'
import { handler as discoveryRun } from '../lib/api-handlers/_discovery-run'
import { handler as marketFx } from '../lib/api-handlers/_market-fx'
import { handler as marketWsToken } from '../lib/api-handlers/_market-ws-token'
import { handler as marketMacro } from '../lib/api-handlers/_market-macro'
import { handler as marketSectorRotation } from '../lib/api-handlers/_market-sector-rotation'
import { handler as jobsPreMarket } from '../lib/api-handlers/_jobs-pre-market'
import { handler as jobsNewsRefresh } from '../lib/api-handlers/_jobs-news-refresh'
import { handler as jobsEodReport } from '../lib/api-handlers/_jobs-eod-report'
import { handler as jobsEveningDigest } from '../lib/api-handlers/_jobs-evening-digest'
import { handler as jobsOvernightPrep } from '../lib/api-handlers/_jobs-overnight-prep'
import { handler as jobsNewsPurge } from '../lib/api-handlers/_jobs-news-purge'
import { handler as filingsSummary } from '../lib/api-handlers/_filings-summary'
import { handler as earningsTranscript } from '../lib/api-handlers/_earnings-transcript'
import { handler as searchSemantic } from '../lib/api-handlers/_search-semantic'
import { handler as embeddingsIngest } from '../lib/api-handlers/_embeddings-ingest'
import { handler as sentimentReddit } from '../lib/api-handlers/_sentiment-reddit'
