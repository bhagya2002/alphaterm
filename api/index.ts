...
import { handler as auth } from './_handlers/_auth'
import { handler as authLogout } from './_handlers/_auth-logout'
import { handler as authMe } from './_handlers/_auth-me'
import { handler as portfolio } from './_handlers/_portfolio'
import { handler as portfolioId } from './_handlers/_portfolio-id'
import { handler as portfolioTaxLoss } from './_handlers/_portfolio-tax-loss'
import { handler as watchlist } from './_handlers/_watchlist'
import { handler as watchlistId } from './_handlers/_watchlist-id'
import { handler as alerts } from './_handlers/_alerts'
import { handler as alertsId } from './_handlers/_alerts-id'
import { handler as scores } from './_handlers/_scores'
import { handler as news } from './_handlers/_news'
import { handler as chat } from './_handlers/_chat'
import { handler as screener } from './_handlers/_screener'
import { handler as screenerRank } from './_handlers/_screener-rank'
import { handler as reportsIndex } from './_handlers/_reports-index'
import { handler as reportsGenerate } from './_handlers/_reports-generate'
import { handler as discoveryIndex } from './_handlers/_discovery-index'
import { handler as discoveryRun } from './_handlers/_discovery-run'
import { handler as marketFx } from './_handlers/_market-fx'
import { handler as marketWsToken } from './_handlers/_market-ws-token'
import { handler as marketMacro } from './_handlers/_market-macro'
import { handler as marketSectorRotation } from './_handlers/_market-sector-rotation'
import { handler as jobsPreMarket } from './_handlers/_jobs-pre-market'
import { handler as jobsNewsRefresh } from './_handlers/_jobs-news-refresh'
import { handler as jobsEodReport } from './_handlers/_jobs-eod-report'
import { handler as jobsEveningDigest } from './_handlers/_jobs-evening-digest'
import { handler as jobsOvernightPrep } from './_handlers/_jobs-overnight-prep'
import { handler as jobsNewsPurge } from './_handlers/_jobs-news-purge'
import { handler as filingsSummary } from './_handlers/_filings-summary'
import { handler as earningsTranscript } from './_handlers/_earnings-transcript'
import { handler as searchSemantic } from './_handlers/_search-semantic'
import { handler as embeddingsIngest } from './_handlers/_embeddings-ingest'
import { handler as sentimentReddit } from './_handlers/_sentiment-reddit'
